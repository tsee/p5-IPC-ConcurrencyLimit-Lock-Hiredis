package IPC::ConcurrencyLimit::Lock::Hiredis;
use 5.008001;
use strict;
use warnings;
...
require XSLoader;
XSLoader::load('IPC::ConcurrencyLimit::Lock::Hiredis', $VERSION);
...
IPC::ConcurrencyLimit::Lock::Hiredis - Locking via Redis using hiredis
